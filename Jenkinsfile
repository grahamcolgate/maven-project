pipeline {
    ...
    parameters {
         string (name: 'tomcat_dev', defaultValue: '35.176.130.112', description: 'Staging Server')
         string (name: 'tomcat_prod', defaultValue: '35.178.3.71', description: 'Production Server')
    }
